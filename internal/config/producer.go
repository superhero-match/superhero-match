...
type Producer struct {
	Brokers      []string `env:"KAFKA_BROKERS" yaml:"brokers" default:"[192.168.0.105:9092]"`
	Topic        string   `env:"KAFKA_STORE_MATCH_MATCH_TOPIC" yaml:"topic" default:"store.match.match"`
